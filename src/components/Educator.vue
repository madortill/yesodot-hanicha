    ...
    return {
      curSlide: '1',
        ...
        '2' : {
          ...
          text: 'אין.<br> על מנת להיות חונכים מוצלחים עליכם להתאים את סוג החניכה לנחנך.<br> ברוב המקרים, חונך מכוון תוצאה יתאים  לחניכה על ביצוע בודד, בעוד שחונך מכוון תהליך יתאים לחניכה על תפקיד. <br> ניתן גם לשלב בין השניים'
        }
      }
    };
  },
